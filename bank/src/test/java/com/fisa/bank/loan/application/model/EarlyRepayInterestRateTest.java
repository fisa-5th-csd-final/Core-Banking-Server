...
public class EarlyRepayInterestRateTest {
  ...
  void testCreditFixed() {
    BigDecimal fee =
        EarlyRepayInterestRate.getEarlyRepayInterestRate(LoanType.CREDIT, InterestType.FIXED);
  ...
  void testCreditVariable() {
    BigDecimal fee =
        EarlyRepayInterestRate.getEarlyRepayInterestRate(LoanType.CREDIT, InterestType.VARIABLE);
    assertEquals(new BigDecimal("0.02"), fee);
  }
  ...
  void testMortgageFixed() {
    BigDecimal fee =
        EarlyRepayInterestRate.getEarlyRepayInterestRate(LoanType.MORTGAGE, InterestType.FIXED);
  ...
  void testMortgageVariable() {
    BigDecimal fee =
        EarlyRepayInterestRate.getEarlyRepayInterestRate(LoanType.MORTGAGE, InterestType.VARIABLE);
    assertEquals(new BigDecimal("0.73"), fee);
  }
}
