...
import com.fisa.bank.domains.loan.application.service.calculator.EqualPrincipalCalculator;

public class EqualPrincipalCalculatorTest {
  private final EqualPrincipalCalculator calculatorService = new EqualPrincipalCalculator();

  @Test
  @DisplayName("원금균등상환 계산기 - 월별 이자 및 만기 원금 상환 출력")
