...
public class ResponseCode implements SuccessResponseCode {
    ...
    public static final ResponseCode DELETE = new ResponseCode(HttpStatus.NO_CONTENT, MessageCode.DELETE);
    ...
    @Override
    public String getCode() { return this.messageCode.getCode(); }

    @Override
    public String getMessage() { return this.messageCode.getMessage(); }
}
