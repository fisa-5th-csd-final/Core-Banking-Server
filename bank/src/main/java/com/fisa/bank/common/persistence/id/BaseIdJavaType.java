...
/**
 * Hibernate Custom Type의 공통 구현체
 * T: ID의 기본 타입 (예: Long, UUID)
 * ID: BaseId<T>를 상속받는 구체적인 ID 클래스 (예: UserId)
 */

public abstract class BaseIdJavaType<T, ID extends BaseId<T>>
        extends AbstractClassJavaType<ID> {
