...
public class InterestRateResponse {
    ...
    public InterestRateResponse(BigDecimal baseInterest, BigDecimal addInterest, BigDecimal limitPreferInterest) {
    ...
    public static InterestRateResponse from(InterestRate entity){
        return new InterestRateResponse(
                entity.getBaseInterest(),
                entity.getAddInterest(),
                entity.getLimitPreferInterest()
        );
    }
}
